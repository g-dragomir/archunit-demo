...
import com.demo.payment.archunit.custom.CustomConditions;
import com.demo.payment.archunit.custom.CustomPredicates;
...
public class ClassContainmentTest {
    ...
    public void dateUtilsClassShouldHaveAllTheFieldEndingWithDate(JavaClasses importedClasses) {
        ...
        ArchRule rule = fields()
                ...
                .should(CustomConditions.haveANameEndingWith("Date"));
